...
return [
    'modules' => [
        ...
        'SR_CategoryImage' => 1,
        'Smartcode_Adminconfig' => 0,
        'Smartcode_Adminmenu' => 1,
        'Smartcode_Cancelorder' => 1,
        'Smartcode_Chat' => 1,
        'Smartcode_Customapi' => 1,
        'Smartcode_Customimage' => 1,
        'Smartcode_Customorder' => 1,
        'Smartcode_Customterms' => 1,
        'Smartcode_Dbcollection' => 1,
        'Smartcode_Gridview' => 1,
        'Smartcode_Helloworld' => 0,
        'Smartcode_Jsmodule' => 0,
        'Smartcode_Orderlist' => 1,
        'Smartcode_Trackorder' => 1,
        'Temando_Shipping' => 1,
        'Vertex_Tax' => 1,
