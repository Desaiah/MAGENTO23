<?php
namespace Desaiah\Preorder\Helper;
...
/**
 * Class Data
 * @package Desaiah\Preorder\Helper
 */
class Data extends AbstractHelper
{
    const CUSTOM_SENDER_EMAIL = 'desaiah_product_preorder_section/general/senderemail';
    const CUSTOM_SENDER_NAME  = 'desaiah_product_preorder_section/general/sendername';
    const CONTACT_SENDER_EMAIL = 'contact/email/recipient_email';
    const CONTACT_SENDER_NAME = 'contact/email/sender_email_identity';
    const QUESTION_DISPLAY_SETTING = 'desaiah_product_preorder_section/general/questionenabled';
    const EMAIL_SEND_SETTING_ADMIN  = 'desaiah_product_preorder_section/general/sendemailtoadmin';
    const QUESTION_DISPLAY_COUNT  = 'desaiah_product_preorder_section/general/questioncount';
    ...
    public function sendCustomerEmail($post)
    {
        ...
        $to = array($post['email']);
        $templateIdentifier = "product_preorder_form";
    ...
    public function sendAdminEmail($post)
    {
        ...
        $templateIdentifier = "product_preorder_form_admin";
    ...
    public function sendAdminReplyEmail($post)
    {
        ...
        $this->inlineTranslation->suspend();
        $to = array($post['email']);
        $templateIdentifier = "preorder_reply";
